...
public class CombatDummyController : MonoBehaviour
{
    ...
    private void Knockback()
    {
        ...
        rbAlive.velocity = new(knockbackSpeedX * playerFacingDirection, knockbackSpeedY);
    }
    private void CheckKnockback()
    {
        ...
        {
            knockback = false;
            rbAlive.velocity = new(0.0f, rbAlive.velocity.y);
        }
    }
    ...
    private void Die()
    {
        ...
        rbBrokenBot.velocity = new(knockbackSpeedX * playerFacingDirection, knockbackSpeedY);
        rbBrokenTop.velocity = new(knockbackDeathSpeedX * playerFacingDirection, knockbackDeathSpeedY);
